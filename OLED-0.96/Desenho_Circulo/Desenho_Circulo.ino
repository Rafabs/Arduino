/***********************************************************************************************
 * EXEMPLO DE APLICAÇÃO USANDO MÓDULO OLED 0,96" (Desenho de Círculo)                          *
...
{
  display.clearDisplay ();                                                //Limpa o buffer.
  display.drawCircle (60, 30, 30, WHITE);                                 //Círculo Comum (CenterX, CenterY, Radius in Pixels, WHITE)
  display.fillCircle (50, 20, 5, WHITE);                                  //Fundo preenchido (CenterX, CenterY, Radius in Pixels, WHITE)
  display.fillCircle (70, 20, 5, WHITE);                                  //Fundo preenchido (CenterX, CenterY, Radius in Pixels, WHITE)
