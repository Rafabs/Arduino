/***********************************************************************************************
 * EXEMPLO DE APLICAÇÃO USANDO MÓDULO OLED 0,96" (Tamanho do Texto)                            *
...
void loop() 
{
  ...
  display.print ("A");                                                    //Exibe o texto no Display
  display.setTextSize (2);                                                //Seleciona o tamanho do texto (1=10px. / 2=20px. ...)
  display.print ("A");                                                    //Exibe o texto no Display
  display.setTextSize (3);                                                //Seleciona o tamanho do texto (1=10px. / 2=20px. ...)
  display.print ("A");                                                    //Exibe o texto no Display
  display.setTextSize (4);                                                //Seleciona o tamanho do texto (1=10px. / 2=20px. ...)
  display.print ("A");                                                    //Exibe o texto no Display
  display.setTextSize (5);                                                //Seleciona o tamanho do texto (1=10px. / 2=20px. ...)
  display.print ("A");                                                    //Exibe o texto no Display
  display.setTextSize (6);                                                //Seleciona o tamanho do texto (1=10px. / 2=20px. ...)
  display.print ("A");                                                    //Exibe o texto no Display
