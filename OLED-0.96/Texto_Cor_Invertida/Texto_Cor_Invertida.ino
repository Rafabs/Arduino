/***********************************************************************************************
 * EXEMPLO DE APLICAÇÃO USANDO MÓDULO OLED 0,96" (Texto Cor Invertida)                         *
...
void loop() 
{
  ...
  display.setCursor(10,25);                                               //Seleciona as coordenadas (X,Y)
  display.write("Texto Invertido");                                       //Exibe o texto no Display
