/***********************************************************************************************
 * EXEMPLO DE APLICAÇÃO USANDO MÓDULO OLED 0,96" (Desenho de Ponto/Pixels)                     *
...
void loop() {
  display.clearDisplay ();                                                //Limpa o buffer.
  display.drawPixel (20, 35, WHITE);                                      //Pixel na posição X,Y na cor branca
  display.drawPixel (45, 12, WHITE);                                      //Pixel na posição X,Y na cor branca
  display.drawPixel (120, 59, WHITE);                                     //Pixel na posição X,Y na cor branca
  display.drawPixel (97, 20, WHITE);                                      //Pixel na posição X,Y na cor branca
  display.drawPixel (35, 36, WHITE);                                      //Pixel na posição X,Y na cor branca
  display.drawPixel (72, 19, WHITE);                                      //Pixel na posição X,Y na cor branca
  display.drawPixel (90, 7, WHITE);                                       //Pixel na posição X,Y na cor branca
  display.drawPixel (11, 29, WHITE);                                      //Pixel na posição X,Y na cor branca
  display.drawPixel (57, 42, WHITE);                                      //Pixel na posição X,Y na cor branca
  display.drawPixel (69, 34, WHITE);                                      //Pixel na posição X,Y na cor branca
  display.drawPixel (108, 12, WHITE);                                     //Pixel na posição X,Y na cor branca
